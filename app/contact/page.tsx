...
export const metadata: Metadata = {
  title: 'Contact Us',
  description:
    "Get in touch with Schematic Marketing. Let's discuss your project, goals, and how we can help architect your brand's growth.",
};

const contactInfo = [
  {
    label: 'Email',
    value: 'hello@schematicmarketing.com',
    href: 'mailto:hello@schematicmarketing.com',
    icon: (
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Absolutely. While we are based in San Francisco, we work with clients worldwide. Our collaborative tools and communication processes ensure seamless remote partnerships.',
  },
  {
        ...
        <div className="container">
          ...
          <div className={styles.contactGrid}>
            ...
            <aside className={styles.sidebar}>
              <div className={`surface ${styles.contactInfo}`}>
                <h3>Get in Touch</h3>
              ...
              <div className={`surface ${styles.availability}`}>
                <h3>Availability</h3>
                <p>
              ...
              <div className={`surface ${styles.social}`}>
                <h3>Follow Along</h3>
      ...
      <section className={`section ${styles.faqSection}`} aria-labelledby="faq-heading">
        <div className="container">
          ...
          <div className={styles.faqGrid}>
            {faqs.map(faq => (
              <article key={faq.question} className={`surface ${styles.faqCard}`}>
                <h3>{faq.question}</h3>
                <p>{faq.answer}</p>
              </article>
            ))}
